        ...
        <div class="flex items-center justify-center min-h-screen">
            <div class="w-full max-w-3xl p-6 bg-white rounded-lg shadow-md">
                ...
                <form action="../../controller/RequestController.php" method="POST" class="mt-6 space-y-4">
                    ...
                    <div>
                        <label for="division" class="block text-sm font-medium text-black">Division:</label>
                        <input type="text" name="division" id="division" value="<?= htmlspecialchars($user['division']) ?>" required class="w-full px-4 py-2 mt-1 text-sm text-black bg-green-50 border border-green-300 rounded-md focus:ring-green-500 focus:border-green-500">
                    </div>
                    <div>
