            ...
            <table class="w-full">
                ...
                <tbody>
                    <?php if (!empty($peminta)): ?>
                        <?php foreach ($peminta as $row): ?>
                            <tr class="border-b hover:bg-gray-100">
                                <td class="px-6 py-4"><?= htmlspecialchars($row['nama_peminta']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($row['nama_item']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($row['jumlah']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($row['satuan']) ?></td>
