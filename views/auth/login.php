...
<head>
    ...
    <title>Login - PT Dharma Electrindo Manufacturing</title>
</head>
...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex items-center justify-center min-h-screen">
        <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
            ...
            <form action="../../controller/LoginController.php" method="POST" class="mt-6 space-y-4">
                <div>
                ...
                <div>
                    ...
                    <span class="text-gray-900">Don't have an account? <a href="register.php" class="text-green-600">Sign up</a></span>
                </div>
                <button type="submit"
                    class="w-full px-4 py-2 text-sm font-semibold text-white  rounded-md bg-green-500 shadow-lg shadow-green-500/50 hover:bg-green-400">
                    Login
                </button>
            </form>
        </div>
