                    ...
                    <?php if (!empty($items)): ?>
                        <?php foreach ($items as $items): ?>
                            <tr class="border-b hover:bg-gray-100">
                                <td class="px-6 py-4"><?= htmlspecialchars($items['nama_item']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($items['jumlah']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($items['satuan']) ?></td>
                                <td class="px-6 py-4"><?= htmlspecialchars($items['keterangan']) ?></td>
                                <td>
                                    <?= htmlspecialchars($items['status_barang']); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
