...
class PesananModel
{
    ...
    public function pesanan($user_id, $date, $nama_peminta, $ext_phone, $request_date, $request_time, $facility, $nama_item, $jumlah, $satuan, $keterangan, $status_barang, $status)
    {
        ...
        $stmt->bind_param("isssssssssssss", $user_id, $date, $nama_peminta, $ext_phone, $request_date, $request_time, $facility, $nama_item, $jumlah, $satuan, $keterangan, $status_barang, $status);
    ...
    {
        $sql = "UPDATE peminta SET status_barang = ?, status = ?, updated_at = NOW() WHERE id = ?";
        $stmt = $this->conn->prepare($sql);
